...
INC = include
BIN = bin
OBJS = $(OBJ)/factorization.o $(OBJ)/prime_generator.o $(OBJ)/miller_rabin.o $(OBJ)/generator.o $(OBJ)/crt.o $(OBJ)/bsgs.o $(OBJ)/main.o 
HDRS = $(INC)/factorization.h $(INC)/prime_generator.h $(INC)/miller_rabin.h $(INC)/generator.h $(INC)/crt.h $(INC)/bsgs.h
CFLAGS = -Wall -c -I$(INC) 
